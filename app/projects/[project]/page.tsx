  ...
  return (
    <div className="max-w-3xl mx-auto py-20">
      <header className="flex items-center justify-between">
        ...
        <a
          className="bg-gray-100 rounded-lg text-gray-500 font-bold py-3 px-4 whitespace-nowrap hover:bg-blue-500 hover:text-blue-100 hover:cursor-pointer transition"
          href={project.url}
          title="View Project"
          target="_blank"
